...
let myArray = ["M3", "audi q2", "BMW motorcycle"];
console.log("i would like to own", myArray[0]);
console.log("i would like to own", myArray[1]);
console.log("i would like to own", myArray[2]);
